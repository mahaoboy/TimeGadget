...
public class SimpleProjectRest {
	...
	SimpleProjectRest(CustomFieldManager customFM, IssueTypeManager itM,
			I18nResolver i18n, OptionsManager opM, SimpleProjectChart barchart) {
			...
			try {
				return Response.ok(
						barchart.generateChart(Integer.parseInt(width),
								...
								Long.parseLong(timeId), issuetypeId)).build();
			} catch (MyException e) {
